...
namespace NeoFPS
{
    ...
    public class NeoFpsAudioManager : NeoFpsManager<NeoFpsAudioManager>
    {
        ...
        [SerializeField, Tooltip("An optional prefab for the spatial effects sources. If not provided then the objects will be created from scratch.")]
        ...
        [SerializeField, Tooltip("An optional prefab for the ambience effects sources. If not provided then the objects will be created from scratch.")]

...
namespace NeoFPS
{
	...
	public class FirstPersonCamera : MonoBehaviour, INeoSerializableComponent
	{
		...
		[SerializeField, Range(22.5f, 90f), Tooltip("The vertical field of view")]
		private float m_DefaultFoV = 50.625f;
        ...
        {
            get { return m_CurrentInputMultiplier; }
        }
        ...
        {
            m_Camera.fieldOfView = m_DefaultFoV * fovMultiplier;
            if (m_Aimer != null)

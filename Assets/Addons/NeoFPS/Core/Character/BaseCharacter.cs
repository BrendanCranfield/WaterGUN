...
namespace NeoFPS
{
    ...
    public abstract class BaseCharacter : MonoBehaviour, ICharacter, INeoSerializableComponent
    {
        ...
        [Tooltip("The additive transform handler attached to the head heirarchy of this character (used for things like weapon recoil and impacts).")]
        [SerializeField] private AdditiveTransformHandler m_HeadTransformHandler = null;

        [Tooltip("The additive transform handler attached to the body heirarchy of this character (used for things like leaning and impacts).")]
        [SerializeField] private AdditiveTransformHandler m_BodyTransformHandler = null;

...
namespace NeoFPSEditor.Hub
{
    public class NeoFpsHubEditor : EditorWindow
    {
        ...
        void InitialiseWizards()
        {
            ...
            AddPage("Wizards/Player Character", "wizard_player_character", new NeoFpsWizardPage<PlayerCharacterWizard>("Player Character Wizard", "Create a new player character"), index++);
            AddPage("Wizards/Modular Firearm", "wizard_firearm", new NeoFpsWizardPage<ModularFirearmWizard>("Modular Firearm Wizard", "Create a new firearm"), index++);
            //AddPage("Wizards/Firearm Animator", "wizard_firearmanim", new NeoFpsWizardPage<FirearmAnimatorWizard>("Firearm Animator Wizard", "Set up a firearm animator controller"), index++);
            AddPage("Wizards/Melee Weapon", "wizard_melee", new NeoFpsWizardPage<MeleeWeaponWizard>("Melee Weapon Wizard", "Create a new melee weapon"), index++);
            AddPage("Wizards/Thrown Weapon", "wizard_thrown", new NeoFpsWizardPage<ThrownWeaponWizard>("Thrown Weapon Wizard", "Create a new thrown weapon"), index++);
            AddPage("Wizards/Pickup", "wizard_pickup", new NeoFpsWizardPage<PickupWizard>("Pickup Wizard", "Create a new pickup"), index++);
            AddPage("Wizards/Interactive Object", "wizard_interactive", new NeoFpsWizardPage<InteractiveObjectWizard>("Interactive Object Wizard", "Create a new interactive object"), index++);

...
namespace NeoFPSEditor.Hub.Pages.ItemCreationWizards
{
    ...
    {
        //[SerializeField, HideInInspector] private List<NeoFpsWizardStep> m_StepValues = new List<NeoFpsWizardStep>();
        //[SerializeField, HideInInspector] private List<string> m_StepKeys = new List<string>();

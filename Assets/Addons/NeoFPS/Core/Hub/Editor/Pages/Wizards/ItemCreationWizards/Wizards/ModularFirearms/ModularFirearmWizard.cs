...
namespace NeoFPSEditor.Hub.Pages.ItemCreationWizards
{
    public class ModularFirearmWizard : NeoFpsWizard
    {
        ...
        public override void CreateItem()
        {
            ...
            // Modules
            var shooter = AddShooter(rootObject, displayObject, weaponObject);
            ...
            var muzzleEffect = AddMuzzleEffect(rootObject, displayObject, weaponObject);
            var shellEject = AddShellEject(rootObject, displayObject, weaponObject);
            ...
            if (root.overheat)
            {
                ...
                if (root.hazePrefab != null)
                {
                    ...
                    hazeObject.transform.SetParent(weaponObject.transform, false);
        ...
        IShooter AddShooter(GameObject rootObject, GameObject displayObject, GameObject weaponObject)
        {
            var root = steps[ModularFirearmWizardSteps.root] as ModularFirearmRootStep;
                ...
                case ModularFirearmShooterStep.ShooterModule.Hitscan:
                    {
                        ...
                        else
                        {
                            ...
                            muzzleTipObject.transform.SetParent(weaponObject.transform);
        ...
        IMuzzleEffect AddMuzzleEffect(GameObject rootObject, GameObject displayObject, GameObject weaponObject)
        {
            var root = steps[ModularFirearmWizardSteps.root] as ModularFirearmRootStep;
                ...
                case ModularFirearmMuzzleEffectStep.MuzzleEffectModule.ParticleSystem:
                    {
                        ...
                        if (muzzleEffectStep.particleSystemOption == 0)
                            effectSO.FindProperty("m_ParticleSystem").objectReferenceValue = Instantiate(muzzleEffectStep.particleSystem);
                        else
                ...
                case ModularFirearmMuzzleEffectStep.MuzzleEffectModule.AdvancedParticleSystem:
                    {
                        ...
                        if (muzzleEffectStep.advancedParticleSystemPrefab != null)
                        {
                            ...
                            muzzleEffectObject.transform.SetParent(weaponObject.transform, false);
        ...
        IEjector AddShellEject(GameObject rootObject, GameObject displayObject, GameObject weaponObject)
        {
            var root = steps[ModularFirearmWizardSteps.root] as ModularFirearmRootStep;
                ...
                case ModularFirearmShellEjectStep.ShellEjectModule.Standard:
                    {
                        ...
                        else
                        {
                            ...
                            proxy.transform.SetParent(weaponObject.transform, false);
                ...
                case ModularFirearmShellEjectStep.ShellEjectModule.ParticleSystem:
                    {
                        ...
                        psRoot.transform.SetParent(weaponObject.transform, false);

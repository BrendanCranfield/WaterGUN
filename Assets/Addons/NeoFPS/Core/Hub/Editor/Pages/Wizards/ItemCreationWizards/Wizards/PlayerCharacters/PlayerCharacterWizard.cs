                ...
                case 1: // Full
                    {
                        ...
                        staminaSO.FindProperty("m_WalkSpeedMin").floatValue = staminaStep.walkSpeedMin;
                        staminaSO.FindProperty("m_WalkSpeedMax").floatValue = staminaStep.walkSpeedMax;
                        staminaSO.FindProperty("m_SprintSpeedMin").floatValue = staminaStep.sprintSpeedMin;
                        staminaSO.FindProperty("m_SprintSpeedMax").floatValue = staminaStep.sprintSpeedMax;
                        staminaSO.FindProperty("m_CrouchSpeedMin").floatValue = staminaStep.crouchSpeedMin;
                        staminaSO.FindProperty("m_CrouchSpeedMax").floatValue = staminaStep.crouchSpeedMax;
                        staminaSO.FindProperty("m_AimingSpeedMultiplier").floatValue = staminaStep.aimingSpeedMultiplier;

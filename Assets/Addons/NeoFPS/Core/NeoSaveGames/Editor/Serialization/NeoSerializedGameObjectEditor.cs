...
namespace NeoSaveGames.Serialization
{
    ...
    public class NeoSerializedGameObjectEditor : Editor
    {
        ...
        void GetSaveDetails()
        {
            ...
            {
                var obj = PrefabUtility.GetCorrespondingObjectFromOriginalSource(cast);
                if (obj != null)
                    m_RegisterablePrefab = obj.transform.root.GetComponent<NeoSerializedGameObject>();
            }
        }
            ...
            if (m_RegisterablePrefab != null)
            {
                ...
                if (GUILayout.Button("Register Prefab With SaveGameManager"))
                {
                    ...
                    if (guids != null && guids.Length > 0)
                    {
                        ...
                        EditorGUIUtility.PingObject(m_RegisterablePrefab);

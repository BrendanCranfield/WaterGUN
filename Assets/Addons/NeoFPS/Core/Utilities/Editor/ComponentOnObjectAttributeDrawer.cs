...
namespace NeoFPSEditor
{
    ...
    public class ComponentOnObjectAttributeDrawer : PropertyDrawer
    {
        ...
        public override void OnGUI(Rect position, SerializedProperty property, GUIContent label)
        {
            ...
            if (property.propertyType == SerializedPropertyType.ObjectReference)
            {
                ...
                if (behaviour != null)
                {
                    ...
                    if (current != null)
                        currentName = GetCurrentComponentName(gameObject, castAttr.componentType, current);
                    else
                    {
        ...
        string GetCurrentComponentName(GameObject gameObject, Type t, UnityEngine.Object current)
        {

...
namespace NeoFPS
{
    ...
    public class PoolManager : NeoFpsManager<PoolManager>
    {
        ...
        [SerializeField, Tooltip("The size of any new pools that are added to the array after initialisation.")]
        private int m_DefaultPoolSize = 100;
        ...
        public static int defaultPoolSize
        {
            get
            {
                if (CheckScenePoolHandler())
                    return instance.m_DefaultPoolSize;
                else
                    return 100;
            }
        }
        ...
        {
            if (CheckScenePoolHandler())
                s_CurrentScenePoolInfo.CreatePool(prototype, instance.m_DefaultPoolSize);
        }

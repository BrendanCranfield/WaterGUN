...
namespace NeoFPS.ModularFirearms
{
    ...
    public class AdvancedParticleMuzzleEffect : BaseMuzzleEffectBehaviour
    {
        ...
        [SerializeField, RequiredObjectProperty, Tooltip("The effect transform will be reparented under the character so it persists between weapon switches and handles character movement better.")]

...
namespace NeoFPS
{
    ...
    public class HolographicSight : MonoBehaviour, IOpticsBrightnessControl, INeoSerializableComponent
    {
        ...
        [SerializeField, RequiredObjectProperty, Tooltip("The game object with the reticule mesh attached. This should be placed directly in front of the weapon at the desired distance")]

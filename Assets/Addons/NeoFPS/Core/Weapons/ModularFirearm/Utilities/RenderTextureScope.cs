...
namespace NeoFPS.ModularFirearms
{
    ...
    {
        [Header("Camera")]
        [SerializeField, Tooltip("The scope camera")]
        ...
        [SerializeField, Tooltip("The mesh renderer of the scope lens which will receive the render texture")]
        ...
        [Header("Reticule")]
        [SerializeField, Tooltip("The transform of the reticule geometry. Local position (0,0,0) should be centered on the camera and slightly in front.")]
        ...
        [SerializeField, Tooltip("A transform that represents the lens of the scope that the player looks into. Used to determine the off-axis angle for parallax and fade")]
